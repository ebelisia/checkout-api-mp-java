          ...
          <div class="content">
            <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <img class="img-fluid mx-auto d-block image"
                          src="https://www.nextel.com.br/css/geral/img/aparelhos/iphone_5s.png">
                      </div>
                      <div class="col-md-8">
                        <div class="info">
                          <div class="row">
                            <div class="col-md-5 product-name">
                              <div class="product-name">
                                ...
                                <div class="product-info">
                                  <div>screen: <span class="value">5 inch</span></div>
              ...
              <div class="col-md-12 col-lg-4">
                <div class="summary">
                  <h3>cart</h3>
                  <div class="summary-item"><span class="text">Total</span><span class="price">$ 200</span></div>
